Shader stats.TextMeshPro/Mobile/Bitmapstats. {

Properties {
	_MainTex		(stats.Font Atlasstats., 2D) = stats.whitestats. {}
	[HDR]_Color		(stats.Text Colorstats., Color) = (1,1,1,1)
	_DiffusePower	(stats.Diffuse Powerstats., Range(1.0,4.0)) = 1.0
...
SubShader {
	...
	Blend SrcAlpha OneMinusSrcAlpha
	BindChannels {
		Bind stats.Colorstats., color
		Bind stats.Vertexstats., vertex
		Bind stats.TexCoordstats., texcoord0
	}
	Pass {
		SetTexture [_MainTex] {
